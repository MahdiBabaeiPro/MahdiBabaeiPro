...
<h2 align=right>💻 سلام مهدی بابائی هستم👋 </h2>

<h2 align=center>❤️ برنامه نویس پایتون و اس کیو ال هستم🐍 .علاقه مند به دنیای برنامه نویسی 👨🏻‍💻و عاشق لینوکس هستم🐧💻.در اوقات فراغت توزیع های لینوکسی را امتحان می کنم  </h2>
